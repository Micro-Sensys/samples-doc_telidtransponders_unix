...
This repository contains sample codes for handling **TELID®200** sensor transponders on devices running UNIX using a Micro-Sensys RFID reader

> For details on DOC communication check [Useful Links](#Useful-Links) 

## Available TELID®200 sample codes
* [.NET library](dotnet)
* [Java library](java)
